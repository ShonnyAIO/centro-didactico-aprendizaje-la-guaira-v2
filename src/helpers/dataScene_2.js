...
const Scene = {
    salaIndices: {
        ...
        hostSpots: {
            ...
            labFisica: {
                type: 'custom',
                pitch: -56.03173850215555,
                yaw: -96.79469475143384,
                scene: 'labFisica',
                cssClass: 'moveScene_Fisica'
            },
            labAstronauta: {
                type: 'custom',
                pitch: -51.005137550951085,
                yaw: -69.370030572588,
                scene: 'labAstronauta',
            ...
            salaMaritima: {
                type: 'custom',
                pitch: -44.08071185459225,
                yaw: -54.09737353253315,
                scene: 'salaMaritima',
                cssClass: 'moveScene_Maritima'
            },
            salaAcuatica: {
                type: 'custom',
                pitch: -28.03813547725765,
                yaw: -34.03913145845411,
                scene: 'salaAcuatica',
                cssClass: 'moveScene_Acuatica'
            },
            sala4Puntos: {
                type: 'custom',
                pitch: -37.592254896528644,
                yaw: -44.48562348194734,
                scene: 'sala4Puntos',
                cssClass: 'moveScene_4_Puntos'
            },
            labSatelital: {
                type: 'custom',
                pitch: -32.03813547725765,
                yaw: -38.03913145845411,
                scene: 'salaSatelital',
